        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`relative flex shrink-0 items-center pb-4 pt-2 font-display text-base md:text-xl tracking-wide transition-all duration-300 border-b-2 select-none outline-none focus:outline-none ${
