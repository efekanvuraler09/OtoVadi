    ...
    >
      ...
      <section className="px-4 md:px-8 lg:px-12 mb-24">
        <div className="mx-auto max-w-4xl text-center">
          <p className="text-xs uppercase tracking-widest text-gray-500 mb-4">Hakkımızda</p>
          <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-light tracking-wide text-white/90 leading-tight">
            Geleceğin Sürüş Deneyimini <br className="hidden md:block" /> Yeniden Tanımlıyoruz.
          </h1>
          <p className="mt-6 text-base text-white/60 font-light max-w-2xl mx-auto leading-relaxed">
      ...
      <section className="px-4 md:px-8 lg:px-12 mb-24">
        <div className="mx-auto max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24">
          <div className="space-y-4">
            <h2 className="text-xs uppercase tracking-widest text-gray-500">Vizyonumuz</h2>
            <p className="text-lg md:text-xl font-light tracking-wide text-white/80 leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 className="text-xs uppercase tracking-widest text-gray-500">Misyonumuz</h2>
            <p className="text-lg md:text-xl font-light tracking-wide text-white/80 leading-relaxed">
      ...
      <section className="px-4 md:px-8 lg:px-12 border-t border-border-subtle/30 pt-24">
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="font-serif text-3xl font-light tracking-wide text-white/90">Neden OtoVadi?</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="flex flex-col items-center text-center space-y-5">
              ...
              <h3 className="text-sm uppercase tracking-[0.15em] text-white/90">Yapay Zeka Destekli Keşif</h3>
            ...
            <div className="flex flex-col items-center text-center space-y-5">
              ...
              <h3 className="text-sm uppercase tracking-[0.15em] text-white/90">Premium Katalog</h3>
              <p className="text-sm font-light text-white/60 leading-relaxed max-w-xs">
            ...
            <div className="flex flex-col items-center text-center space-y-5">
              ...
              <h3 className="text-sm uppercase tracking-[0.15em] text-white/90">Kusursuz Karşılaştırma</h3>
              <p className="text-sm font-light text-white/60 leading-relaxed max-w-xs">
